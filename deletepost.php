<?php
  ...
  if(isset($_POST["submit"]))
  {
    ...
    $target="/opt/lampp/htdocs/php/project/upload".$_FILES['image']["name"];
          ...
          $query1="DELETE FROM admin_panel WHERE id='$deletefromurl'";
      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          ...
          <div class="">
            ...
            ?>
              <form class="" action="deletepost.php?Delete=<?php echo $searchq; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="title">Title:</label>
                  <input disabled value="<?php echo $titleupd; ?>" class="form-control" type="text" name="title" id="title" placeholder="Title">
                </div>
                <div class="form-group">
                ...
                <select disabled class="form-control" name="category" id="categoryname">
                  <?php
